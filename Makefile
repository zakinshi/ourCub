...
PATH_RAY_BBNS		= $(PATH_OBJ_BNS)raycasting_b/
B_FILE_RAY_BNS	= $(FILE_RAY_C_BNS:.c=.o)
RAY_OBJ_BNS		= $(addprefix $(PATH_RAY_BBNS), $(B_FILE_RAY_BNS))
#	----------------------------------
...
PATH_SRC_B_BNS		= $(PATH_OBJ_BNS)
FILE_SRC_B_BNS	= $(FILE_SRC_C_BNS:.c=.o)
SRC_OBJ_BNS		= $(addprefix $(PATH_SRC_B_BNS), $(FILE_SRC_B_BNS))
#	----------------------------------

# ** Global Vars
HEADERS_BNS		= ./source_b/cub3d_bonus.h ./source_b/minimap_b/minimap_bonus.h
ALLOBJ_BNS		= $(RAY_OBJ_BNS) $(MNMP_OBJ_BNS) $(PROJ_OBJ_BNS) $(SRC_OBJ_BNS) $(PARS_OBJ_BNS)
# **
...
$(PATH_OBJ_BNS)%.o: $(PATH_SRC_BNS)%.c $(HEADERS_BNS)
		...
		@mkdir -p $(PATH_RAY_BBNS)
		@mkdir -p $(PATH_MNMP_BNS)
